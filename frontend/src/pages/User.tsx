...
function User() {
    ...
    return (
        <div className="h-screen w-screen p-8 gap-12 flex flex-col items-center bg-linear-to-t from-(--gradient-dark) to-(--gradient-light)">
			...
			<div className="relative h-1/3 w-full grid grid-cols-4 bg-(--gradient-light) shadow-2xs rounded-4xl overflow-auto">
				<div className="col-start-1 flex items-center justify-center p-4">
					<div className="relative h-full aspect-square rounded-full bg-[url(/game01.jpg)] bg-cover bg-center outline-4 outline-slate-300 shadow-md flex items-end justify-end">
						...
						<button onClick={buttonTest} className="absolute h-12 w-12 bg-black/50 rounded-sm bottom-2 right-2 flex items-center justify-center text-white text-xl">
				...
				<div className="col-start-2 col-end-3 w-full p-6 flex items-center gap-4 text-left font-aldrich text-md text-slate-200">
					...
					<button onClick={buttonTest} className="h-14 w-14 flex items-center justify-center bg-black/50 rounded-sm text-white text-2xl">
			...
			<div className="w-2/3 p-12 gap-8 flex flex-col md:flex-row items-center justify-center">
				{/* Room buttons */}
				<div className="p-4 gap-4 flex flex-col">
					...
					<div className="flex flex-col lg:flex-row gap-4">
						<button onClick={buttonTest} className="customButton"
							>Join room</button>
				...
				<button onClick={handleDelete} className="customButton">
					<p>Delete account</p>
				</button>
				{showDeleteConfirm && (
      				<div className="absolute inset-0 flex items-center justify-center z-50 animate-appear bg-black opacity-50">
